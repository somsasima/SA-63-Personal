...
declare function createRouter({ preparers, generators, publisher, config, dockerClient, }: RouterOptions): Promise<express.Router>;

export { DirectoryPreparer, GeneratorBuilder, Generators, LocalPublish, PreparerBuilder, Preparers, PublisherBase, TechdocsGenerator, createRouter };
